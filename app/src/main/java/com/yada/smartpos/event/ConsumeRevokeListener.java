 ...
 * 撤销Emv流程控制监听
 */
public class ConsumeRevokeListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public ConsumeRevokeListener(MainActivity mainActivity, TransHandleListener handleListener) {
