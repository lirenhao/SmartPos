 ...
 * Emv流程控制监听
 */
public class InstallmentPayListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public InstallmentPayListener(MainActivity mainActivity, TransHandleListener handleListener) {
