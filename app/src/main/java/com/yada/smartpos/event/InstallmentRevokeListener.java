 ...
 * 撤销Emv流程控制监听
 */
public class InstallmentRevokeListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public InstallmentRevokeListener(MainActivity mainActivity, TransHandleListener handleListener) {
