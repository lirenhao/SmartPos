 ...
 * Emv流程控制监听
 */
public class PreAuthCompleteListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public PreAuthCompleteListener(MainActivity mainActivity, TransHandleListener handleListener) {
