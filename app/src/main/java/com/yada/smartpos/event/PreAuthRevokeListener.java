 ...
 * 撤销Emv流程控制监听
 */
public class PreAuthRevokeListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public PreAuthRevokeListener(MainActivity mainActivity, TransHandleListener handleListener) {
