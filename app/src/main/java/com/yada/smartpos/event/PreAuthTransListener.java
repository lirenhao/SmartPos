 ...
 * Emv流程控制监听
 */
public class PreAuthTransListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public PreAuthTransListener(MainActivity mainActivity, TransHandleListener handleListener) {
    ...
    public void onRequestOnline(EmvTransController controller, EmvTransInfo transInfo) throws Exception {
        ...
        respMessage = mainActivity.getVirtualPos().createTraner().preAuth(
