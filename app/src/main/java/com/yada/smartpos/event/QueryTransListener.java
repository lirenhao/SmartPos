 ...
 * Emv流程控制监听
 */
public class QueryTransListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public QueryTransListener(MainActivity mainActivity, TransHandleListener handleListener) {
