 ...
 * Emv流程控制监听
 */
public class SpecialPayListener implements EmvLevel2ControllerExtListener {

    private TransHandleListener handleListener;
    private MainActivity mainActivity;
    private IMessage respMessage;

    public SpecialPayListener(MainActivity mainActivity, TransHandleListener handleListener) {
